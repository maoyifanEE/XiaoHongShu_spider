...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--mode", choices=["collect", "smoke", "login-only", "export-only", "qa-only"], default="collect")
    ...
    try:
        ...
        result = asyncio.run(crawler.run(args.mode, args.creator, args.max_notes))
